...
interface Round6Layout { }

const Round6Layout: React.FC<Round6Layout> = () => {
    ...
    const BodyText = () => {
        return (
            <View style={styles.bodyTextWrapper}>
                ...
                <Text style={styles.bodyText}>6 Rounds - 30 Minutes</Text>
            </View>
        )
    }
    const BodyButtons = () => {
    ...
    const RoundButtons = () => {
        return (
            <View style={styles.roundButtonsWrapper}>
                ...
                <TouchableOpacity disabled={true} style={styles.roundButton}>
                    <Text style={styles.roundButtonText}>Round 6</Text>
                </TouchableOpacity>
